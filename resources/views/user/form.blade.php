...
<div class="form-group col-md-3">
    ...
    {!! Form::select('gender', ['male' => __('lang_v1.male'), 'female' => __('lang_v1.female')], !empty($user->gender) ? $user->gender : null, ['class' => 'form-control', 'id' => 'gender', 'placeholder' => __( 'messages.please_select') ]); !!}
</div>
<!--<div class="form-group col-md-3">
...
<div class="form-group col-md-3">
  ...
  <!-- @show_tooltip(__('lang_v1.tax_payer_id_help'))-->
    {!! Form::text('bank_details[tax_payer_id]', !empty($bank_details['tax_payer_id']) ? $bank_details['tax_payer_id'] : null, ['class' => 'form-control', 'id' => 'tax_payer_id', 'placeholder' => __( 'NPWP') ]); !!}
</div>