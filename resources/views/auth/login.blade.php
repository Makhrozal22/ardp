...
@section('content')
        <div class ="login form col-md-12 col-sm-12 pull-right">
        <p class="form-header text-white"><br>@lang('lang_v1.login')</br></p>
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                ...
                <input id="username" type="text" class="form-control" name="username" value="{{ $username }}" required autofocus placeholder="Masukkan Username">
            ...
            <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                value="{{ $password }}" required placeholder="Masukkan Password">
            ...
            <br>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-flat btn-login col-md-12 col-sm-12 pull-right">@lang('lang_v1.login')</button>
                @if(config('app.env') != 'demo')
